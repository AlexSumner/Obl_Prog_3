...
namespace Obl_Prog_3.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Asientos,Precio")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Asientos,Precio")] Reserva reserva)
        {
            if (id != reserva.Id)
            {
                return NotFound();
