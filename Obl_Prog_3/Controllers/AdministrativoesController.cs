...
namespace Obl_Prog_3.Controllers
{
    public class AdministrativoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroTrabajador,Id,Nombre,Email,Telefono,Contraseña")] Administrativo administrativo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroTrabajador,Id,Nombre,Email,Telefono,Contraseña")] Administrativo administrativo)
        {
        ...
        {
          return (_context.Administrativos?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
