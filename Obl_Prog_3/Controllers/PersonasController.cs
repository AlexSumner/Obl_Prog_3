...
namespace Obl_Prog_3.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Telefono,Contraseña")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Telefono,Contraseña")] Persona persona)
        {
            if (id != persona.Id)
            {
                return NotFound();
